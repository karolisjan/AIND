...
def main():
    ...
    test_agents = [Agent(CustomPlayer(score_fn=custom_score, **CUSTOM_ARGS), "custom")]
    
    improved_agents = [Agent(CustomPlayer(score_fn=improved_score, **CUSTOM_ARGS), "ID_Improved")]

    print(DESCRIPTION)
    import datetime as dt
    for agentUT in improved_agents:
